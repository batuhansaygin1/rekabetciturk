...
if ($kullanici_kim['resim'] != '') $onizleme_resim = '<img src="'.$kullanici_kim['resim'].'" alt="Kullanıcı Resmi" style="width: 147px;height:143px;">';
elseif ($ayarlar['kul_resim'] != '') $onizleme_resim = '<img src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi" style="width: 147px;height:143px;">';
else $onizleme_resim = '';
...
elseif ( (($kullanici_kim['son_hareket'] + $ayarlar['cevrimici']) > time() ) AND
