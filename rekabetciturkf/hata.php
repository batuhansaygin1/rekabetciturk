...
$bilgi_no[14] = 'Etkinleştirme kodu başvurunuz tamamlanmıştır.<br><br>Size gelen E-Postadaki bağlantıyı tıklayarak hesabınızı etkinleştirebilirsiniz.<br>Posta kutularınızı kontrol edin, spam kutusuna düşmüş olabilir.<br><br>Giriş yapmak için <a href="giris.php">tıklayın.</a>';
...
$bilgi_no[20] = 'Yeni şifre başvurunuz tamamlanmıştır.<br><br>Şifre sıfırlaması için yapılması gerekenler gönderilen E-Postada anlatılmaktadır.<br>Posta kutularınızı kontrol edin, spam kutusuna düşmüş olabilir.<br><br>Giriş yapmak için <a href="giris.php">tıklayın.</a>';
...
$hata_no[22] = 'Şifreniz Hatalı!<br>Caps Lock açık kalmış olabilir, şifrelerde büyük/küçük harf ayrımı vardır.<br><br>Lütfen geri dönüp <a href="giris.php">tekrar</a> deneyin.<br><br>Şifreyi hatırlamıyorsanız <a href="yeni_sifre.php">tıklayın.</a>';

$hata_no[23] = 'Hesabınız henüz etkinleştirilmemiş !<br><br>Etkinleştirme için yapılması gerekenler gönderilen E-Postada anlatılmaktadır.<br>Posta kutularınızı kontrol edin, spam kutusuna düşmüş olabilir.<br><br><a href="etkinlestir.php">Etkinleştirme kodunu tekrar yolla</a>';
...
$hata_no[64] = 'Özel ileti başlığı en az 3, en fazla 200 karakterden oluşmalıdır.<br><br>Özel İleti içeriği en az 3 karakterden oluşmalıdır.';
...
$hata_no[211] = 'Hesap etkinleştirmesi sadece yöneticiler tarafından yapılmaktadır !<br><br>
Hesabınızın etkinleştirilmesi için yöneticinin onayını beklemelisiniz.';
