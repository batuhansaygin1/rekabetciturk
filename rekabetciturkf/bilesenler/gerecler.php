...
function bbcode_acik($metin, $kodno)
{
    ...
    $donen = preg_replace('|\[thumb\]([a-z0-9?&\\/\-_+.:,=#!@%;ğĞüÜŞşIİıÖöÇç ]+?)\[/thumb\]|si','<a href="\\1" target="_blank"><img src="\\1" width="400" alt="." style="border:1px solid #ddd" /></a>',$donen);
...
':)', ':d', ';)', ':(', ':g', ':p', '(h)', ':-a', ':i', ':-s', ':|', '*-)', '|-)', '-o)', ':-b', ':-o', ':xm', ':xp', ':mh', ':xb', ':x-bn', ':1a', ':4d', ':2b', ':3c', ':6f', ':5e', ':ag', ':s', ':7s', ':8t', ':9y'
);
...
'igrendim.png',
'peh.png',
'ne_desem_bilemedim.png',
'sekilli_gulumseme.png',
'uykum_geldi.png',
'saskin.png',
'sok_oldum.png',
'oha.png',
