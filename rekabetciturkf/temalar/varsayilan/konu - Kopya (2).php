...
<div class="yazar-bilgi" style="border:0px solid #ccc;border-bottom:0px solid #bbb;border-right:0px solid #bbb;"><div>{CEVAP_YAZAN_RESMI}</div>
<div style="position: relative;top: -14.3px;left: 3.4px;"><img src="temalar/varsayilan/resimler/kullanici_cevrimdisi.png"></div>
<span style="position: relative;top: -14.3px;">
