...
<div class="link-agaci" style="font-size: 12.7px;">{FORUM_ANASAYFA}{FORUM_BASLIK}{ALT_FORUM_BASLIK}</div>

<div style="float: left; position: relative; width: 100%; height: 40px;">
<div style="float: right; position: relative; width: 100%; text-align: right;"><b style="float: left; text-align: left;color: #565656;font-size: 21.6px;position: relative;top: 7.9px;">{KONU_BASLIK}</b>{BASLIK_CEVAP}</div>
<div style="float: right; position: relative; width: 100%" class="sayfalama">{SAYFALAMA}</div>
</div>
...
<!--__KOSUL_BASLAT-1__-->
	...
	<tr>
	<td colspan="2" class="rekabetciturk-baslik" align="left">
{KONU_ANAME}
<span><image src="temalar/varsayilan/resimler/bitidiklerim.png" style="padding-bottom: 5px;position: relative;top: 7px;" />   {KONU_TARIHI}</span><div align="right" style="width:57%; float:right; position:relative;top: -1.6px;">
{KONU_ALINTI_DUZENLE}
</div>
	</td>
	</tr>
...
<div class="yazar-bilgi" style="border:0px solid #ccc;border-bottom:0px solid #bbb;border-right:0px solid #bbb;position: relative;top: 22px;"><b style="font-size: 16px;">{KONU_ACAN}</b></div>
<div class="yazar-bilgi" style="border:0px solid #ccc;border-bottom:0px solid #bbb;border-right:0px solid #bbb;background: #9acd3200;position: relative;top: 13.4px;">{KONU_ACAN_YETKISI}</div>
<div class="yazar-bilgi" style="border:0px solid #ccc;border-bottom:0px solid #bbb;border-right:0px solid #bbb;"><div>{KONU_ACAN_DURUM}{KONU_ACAN_RESMI}</div></div>

<span style="position: relative;top: 1.6px;">
<div class="yazarbilgisi" style="background: #fff;color: #3e3e3e;border: 1px solid #cccccc;padding: 3px 3px 3px 10px;margin-top: 2px;text-align: left;-moz-border-radius: 10px;-webkit-border-radius: 5px;border-radius: 5px;font-family: Verdana, Arial, Sans-Serif;font-size: 13px;white-space: nowrap;position: relative;top: -7px;"><img src="temalar/varsayilan/resimler/kayittarihi.png">&nbsp;&nbsp;&nbsp;&nbsp;<span style="position: relative;top: -1.6px">{KONU_ACAN_KAYIT}</span></div>
<div class="yazarbilgisi" style="background: #fff;color: #3e3e3e;border: 1px solid #cccccc;padding: 3px 3px 3px 10px;margin-top: 2px;text-align: left;-moz-border-radius: 10px;-webkit-border-radius: 5px;border-radius: 5px;font-family: Verdana, Arial, Sans-Serif;font-size: 13px;white-space: nowrap;position: relative;top: -4px;"><img src="temalar/varsayilan/resimler/paylasim.png">&nbsp;&nbsp;&nbsp;&nbsp;<span style="position: relative;top: -1.6px">{KONU_ACAN_MESAJSAYI} Paylaşım yaptı</span></div>
...
<div class="yazar-bilgi" style="border:0px solid #ccc;border-bottom:0px solid #bbb;border-right:0px solid #bbb;position: relative;top: 3.7px;"><font size="1" face="verdana">
</span>
...
<div align="right" style="width:45%; float:right; position:relative; padding-top:4px; display: none;">
{KONU_ALINTI_DUZENLE}
</div>
...
<!--__TEKLI_BASLAT-1__-->
	...
	<td colspan="2" class="rekabetciturk-baslik" align="left">
{CEVAP_ANAME}
<div style="float: left; text-align: left; width: 30%;"><b style="color: #565656;">{ILETI_NO} &nbsp;</b>{CEVAP_TARIHI}</div>
...
<div style="color: #3e3e3e;position: relative;border: 1px solid #cccccc;margin-top: 2px;text-align: left;-moz-border-radius: 10px;-webkit-border-radius: 5px;border-radius: 5px;font-family: Verdana, Arial, Sans-Serif;font-size: 13px;white-space: nowrap;top: 14px;"><img src="temalar/varsayilan/resimler/turkculerotagi.jpg" style="display: block;" title="Türkçüler Otağının 1. Üyesi"></div>

<div style="color: #3e3e3e;position: relative;border: 1px solid #cccccc;margin-top: 2px;text-align: left;-moz-border-radius: 10px;-webkit-border-radius: 5px;border-radius: 5px;font-family: Verdana, Arial, Sans-Serif;font-size: 13px;white-space: nowrap;top: 16.4px;"><img src="temalar/varsayilan/resimler/yasruhayranlari.jpg" style="display: block;" title="Yaşrru Hayranlarının 1. Üyesi"></div>
...
<br>
	...
	<td valign="top" height="150" align="left">
<div align="left" style="width:52%; float:left; position:relative; padding-left:10px; margin-top:10px;display: none;">
<div class="masa-gizle tablet-gizle">
<b style="color: #565656;">{ILETI_NO} &nbsp;</b><br>
</div>
</div>
<div align="right" style="width:45%; float:right; position:relative; padding-top:4px;display: none;">
{CEVAP_ALINTI_DUZENLE}
...
<div style="clear:both; position:relative; margin:0px 4px 0px 4.3px; overflow:auto; word-wrap:break-word">
