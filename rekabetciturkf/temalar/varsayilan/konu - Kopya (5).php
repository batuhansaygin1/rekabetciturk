...
{KONU_ANAME}
<span style="position: relative;top: 3.7px;">{KONU_TARIHI}</span>
<span float="right" style="position: relative;top: 1.6px;">{TESEKKUR}</span>
	</td>
	</tr>
...
<b style="color: #565656;font-size: 12px;">{KONU_BASLIK2}</b> <br>
</div>
...
<!--__TEKLI_BASLAT-1__-->
	...
	<td colspan="2" class="forum-kategori-alt-baslik" align="left">
{CEVAP_ANAME}
<div style="float: left; text-align: left; width: 70%; position: relative; top: 3.7px;">{CEVAP_TARIHI}</div>
<div style="float: right; text-align: right; font-size: 11px; position: relative; top: 3px; width: 30%">
<span float="right" style="position: relative;top: -1px;">{CVP_TESEKKUR}</span>
</div>
	</td>
	</tr>
