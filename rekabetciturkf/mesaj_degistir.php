...
if ($mesaj_sahibi['resim']) $onizleme_resim = '<img src="'.$mesaj_sahibi['resim'].'" alt="Kulanıcı Resmi" style="width: 147px;height:143px;">';
...
elseif ( (($mesaj_sahibi['son_hareket'] + $ayarlar['cevrimici']) > time() ) AND
