...
$vtsorgu = "SELECT id,forum_baslik,okuma_izni,konu_acma_izni,yazma_izni,alt_forum FROM $tablo_forumlar WHERE id='$_GET[f]' LIMIT 1";
...
// Yetkiler ve Yardımcılar Eklenti bilgileri çekiliyor
