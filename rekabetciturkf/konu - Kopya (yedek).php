...
$cevap_bag = '<a href="'.linkver('konu.php?k='.$mesaj_satir['id'].'&ks='.$_GET['ks'], $mesaj_satir['mesaj_baslik'], '#c'.$cevap_satir['id']).'" style="color: #565656; text-decoration: none;font-size: 12px;" title="İletinin bağlantısı">#'.$ileti_no.'. İletinin içeriği:</a>';
