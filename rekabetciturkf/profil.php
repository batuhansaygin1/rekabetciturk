...
if ($satir['id'] == 1) $uye_yetki = '<img src="eklentiler/rutberesimleri/kurucu.png" border="0" alt="Kurucu">';

elseif ($satir['yetki'] == 1) $uye_yetki = '<img src="eklentiler/rutberesimleri/yonetici.png" border="0" alt="Yönetici">';

elseif ($satir['yetki'] == 2) $uye_yetki = '<img src="eklentiler/rutberesimleri/yardimci.png" border="0" alt="Yardımcı">';

// bölüm yardımcısı
elseif ($satir['yetki'] == 3)
{
	$uye_yetki = '<img src="eklentiler/rutberesimleri/byardimci.png" border="0" alt="Yardımcı">';
...
else $uye_yetki = '<img src="eklentiler/rutberesimleri/uye.png" border="0" alt="Üye">';
if ($satir['engelle'] == 1) $uye_yetki = '<img src="eklentiler/rutberesimleri/yasakli.png" border="0" alt="Üye">';
...
$uye_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(83,164,196,1) 5%, rgb(93 169 199) 95%);background-color: #57cbde;filter: none;padding: 4px; }</style><font color="#339900">Forumda</font>';


else $uye_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(106,106,106,1) 5%, rgba(85,85,85,1) 95%);background-color: #898989;filter: none;padding: 4px; }</style><font color="#FF0000">Forumda Değil</font>';
...
if ($satir['resim'] != '') $uye_resim = '<img class="kullanicicevrimdurumu" src="'.$satir['resim'].'" alt="Kullanıcı Resmi" title="Kullanıcı Resmi" style="width:147px;max-height:143px;" />';
elseif ($ayarlar['kul_resim'] != '') $uye_resim = '<img class="kullanicicevrimdurumu" src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi" style="width:147px;height:143px;" />';
else $uye_resim = '';
