...
$vtsorgu = "SELECT
id,kullanici_adi,gercek_ad,resim,katilim_tarihi,mesaj_sayisi,sehir_goster,sehir,web,imza,yetki,son_hareket,gizli,engelle,hangi_sayfada,sayfano,ozel_ad,tsk_etti,tsk_edildi
...
$baslik_cevap = '<a style="display:none;" href="mesaj_yaz.php?fno='.$mesaj_satir['hangi_forumdan'].'&amp;kip=yeni" title="Yeni Konu Açmak için Tıklayın">'.$yenibaslik_rengi.'</a> &nbsp;';
...
elseif ($mesaj_sahibi['id'] == 1) 
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/kurucu.png" border="0" alt="Kurucu">';

elseif ($mesaj_sahibi['yetki'] == 1)
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/yonetici.png" border="0" alt="Yönetici">';

elseif ($mesaj_sahibi['yetki'] == 2)
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/yardimci.png" border="0" alt="Yardımcı">';

elseif ($mesaj_sahibi['yetki'] == 3)
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/byardimci.png" border="0" alt="Yardımcı">';

	else $konu_acan_yetkisi = $rutbe;
	if ($mesaj_sahibi['engelle'] == 1)
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/yasakli.png" border="0" alt="Yasaklı">';
	if (empty($mesaj_sahibi['gercek_ad']))
	$konu_acan_yetkisi = '<img src="eklentiler/rutberesimleri/silindi.png" border="0" alt="Üye Silindi">';


if ($mesaj_sahibi['resim'] != '') $konu_acan_resmi = '<img class="kullanicicevrimdurumu" src="'.$mesaj_sahibi['resim'].'" alt="Kullanıcı Resmi" style="width:147px;height:143px;" />';
elseif ($ayarlar['kul_resim'] != '') $konu_acan_resmi = '<img class="kullanicicevrimdurumu" src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi" style="width:147px;height:143px;" />';
...
if (empty($mesaj_sahibi['gercek_ad']))
	$konu_acan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(106,106,106,1) 5%, rgba(85,85,85,1) 95%);background-color: #898989;filter: none;padding: 4px; }</style>';
...
elseif ( (($mesaj_sahibi['son_hareket'] + $zaman_asimi) > $tarih ) AND
	...
	$konu_acan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(83,164,196,1) 5%, rgb(93 169 199) 95%);background-color: #57cbde;filter: none;padding: 4px; }</style>';

else $konu_acan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(106,106,106,1) 5%, rgba(85,85,85,1) 95%);background-color: #898989;filter: none;padding: 4px; }</style>';
...
if (isset($kullanici_kim['id']))
{
	...
	$konu_alinti_duzenle .= '<img src="temalar/varsayilan/resimler/alintiyap.png" alt="Alıntı yaparak cevapla" title="Alıntı yaparak cevapla"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Alıntı yap</span></a>&nbsp;&nbsp;';
}
...
$konu_alinti_duzenle .= '<a href="bilesenler/mesaj_sil.php?fno='.$mesaj_satir['hangi_forumdan'].'&amp;kip=mesaj&amp;mesaj_no='.$mesaj_satir['id'].'&amp;fsayfa='.$_GET['fs'].'"><img src="temalar/varsayilan/resimler/konuyusil.png" alt="Bu konuyu sil" title="Bu konuyu sil"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Sil</span></a>&nbsp;&nbsp;';

$konu_alinti_duzenle .= '<a href="mesaj_degistir.php?fno='.$mesaj_satir['hangi_forumdan'].'&amp;kip=mesaj&amp;mesaj_no='.$mesaj_satir['id'].'&amp;fsayfa='.$_GET['fs'].'"><img src="temalar/varsayilan/resimler/konuyuduzenle.png" alt="Bu konuyu değiştir" title="Bu konuyu değiştir"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Düzenle</span></a>&nbsp;&nbsp;';

$konu_alinti_duzenle .= '<a href="baslik_tasi.php?kip=tasi&amp;mesaj_no='.$mesaj_satir['id'].'"><img src="temalar/varsayilan/resimler/konuyutasi.png" alt="Bu konuyu taşı" title="Bu konuyu taşı"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Konuyu taşı</span></a>&nbsp;&nbsp;';

$konu_alinti_duzenle .= '<a href="bilesenler/mesaj_degistir_yap.php?kip=kilitle&amp;mesaj_no='.$mesaj_satir['id'].'">';

if ($mesaj_satir['kilitli'] == 1)
$konu_alinti_duzenle .= '<img src="temalar/varsayilan/resimler/kilitiac.png" alt="Bu konunun kilitini aç" title="Bu konunun kilitini aç"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Kiliti aç</span></a>&nbsp;&nbsp;';

else $konu_alinti_duzenle .= '<img src="temalar/varsayilan/resimler/konuyukilitle.png" alt="Bu konuyu kilitle" title="Bu konuyu kilitle"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Kilitle</span></a>&nbsp;&nbsp;';
...
$konu_alinti_duzenle .= '<img src="temalar/varsayilan/resimler/altkonuyap.png" alt="Alt konu yap" title="Alt konu yap"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Alt Konu yap</span></a>&nbsp;&nbsp;';

else $konu_alinti_duzenle .= '<img src="temalar/varsayilan/resimler/ustkonuyap.png" alt="Üst konu yap" title="Üst konu yap"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Üst Konu yap</span></a>&nbsp;&nbsp;';

$konu_alinti_duzenle .= '<a href="yonetim/ip_yonetimi.php?kip=1&amp;ip='.$mesaj_satir['yazan_ip'].'"><img  src="temalar/varsayilan/resimler/ipadresleri.png" alt="Bu konuyu açanın ip adresi" title="Bu konuyu açanın ip adresi"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">İp</span></a>&nbsp;&nbsp;';
...
if ($kullanici_kim['kullanici_adi'])
{
	...
	if ($bsatir > 0)
	{
		...
		<span style="display:none;" class="kutu-begenme" title="Daha önce oylama yaptınız"><b>(-<span id="begenmeyens">'.$konu_begenmeyenler.'</span>)</b></span>';
	}
	...
	else
	{
		...
		<a href="javascript:void(0)" id="begenme" onclick="begenmedim()" name="'.$konu_id.'"><span style="display:none;" class="kutu-begenme" title="Eksi"><b>(-<span id="begenmeyens">'.$konu_begenmeyenler.'</span>)</b></span></a>';
	}
}
...
else
{
	...
	<span  style="display:none;" class="kutu-begenme" title="Eksi"><b>(-<span id="begenmeyens">'.$konu_begenmeyenler.'</span>)</b></span>';
}
$konu_acan_imza = '';
...
$konu_tesekkur = '<a style="float:right;" href="eklentiler/tesekkur/tesekkur.php?mesajno='.$mesaj_satir['id'].'"><img src="temalar/varsayilan/resimler/arti.png" border="0" title="Bu mesaja teşekkür edin"><span style="font:bold 13px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#f1ebeb!important;text-decoration:none!important;position:relative;top:-3px;padding:0 5px;">Beğeni gönder</span></a>';
...
'{TSK_EDILDI}' => $mesaj_yazan_tsk_edildi,
'{KONU_ID}' => $konu_id,
...
$vtsorgu = "SELECT id,kullanici_adi,gercek_ad,resim,katilim_tarihi,mesaj_sayisi,sehir_goster,sehir,web,imza,yetki,son_hareket,gizli,engelle,hangi_sayfada,sayfano,ozel_ad,tsk_etti,tsk_edildi
...
elseif ($cevap_sahibi['id'] == 1)
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/kurucu.png" border="0" alt="Kurucu">';

elseif ($cevap_sahibi['yetki'] == 1)
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/yonetici.png" border="0" alt="Yönetici">';

elseif ($cevap_sahibi['yetki'] == 2)
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/yardimci.png" border="0" alt="F. Yardımcı">';

elseif ($cevap_sahibi['yetki'] == 3)
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/byardimci.png" border="0" alt="B. Yardımcı">';

else $cevap_yazan_yetkisi = $rutbe2;

	if ($cevap_sahibi['engelle'] == 1)
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/yasakli.png" border="0" alt="Yasaklı">';
	if (empty($cevap_sahibi['gercek_ad']))
	$cevap_yazan_yetkisi = '<img src="eklentiler/rutberesimleri/silindi.png" border="0" alt="Üye Silindi">';


if ($cevap_sahibi['resim'] != '')
	$cevap_yazan_resmi = '<img class="kullanicicevrimdurumu" src="'.$cevap_sahibi['resim'].'" alt="Kullanıcı Resmi" style="width:147px;height:143px;" />';
elseif ($ayarlar['kul_resim'] != '')
	$cevap_yazan_resmi = '<img class="kullanicicevrimdurumu" src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi" style="width:147px;height:143px;" />';
...
if (empty($cevap_sahibi['gercek_ad']))
	$cevap_yazan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(106,106,106,1) 5%, rgba(85,85,85,1) 95%);background-color: #898989;filter: none;padding: 4px; }</style>';
...
elseif ( (($cevap_sahibi['son_hareket'] + $zaman_asimi) > $tarih ) AND
	...
	$cevap_yazan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(83,164,196,1) 5%, rgb(93 169 199) 95%);background-color: #57cbde;filter: none;padding: 4px; }</style>';

else $cevap_yazan_durum = '<style>.kullanicicevrimdurumu { background: linear-gradient( to bottom, rgba(106,106,106,1) 5%, rgba(85,85,85,1) 95%);background-color: #898989;filter: none;padding: 4px; }</style>';
...
$cevap_alinti_duzenle .= '<a href="bilesenler/mesaj_sil.php?fno='.$mesaj_satir['hangi_forumdan'].'&amp;kip=cevap&amp;mesaj_no='.$mesaj_satir['id'].'&amp;cevap_no='.$cevap_satir['id'].'&amp;fsayfa='.$_GET['fs'].'&amp;sayfa='.$_GET['ks'].'"><img src="temalar/varsayilan/resimler/konuyusil.png"  alt="Bu cevabı sil" title="Bu cevabı sil"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Sil</span></a>&nbsp;&nbsp;';

$cevap_alinti_duzenle .= '<a href="mesaj_degistir.php?fno='.$mesaj_satir['hangi_forumdan'].'&amp;kip=cevap&amp;mesaj_no='.$mesaj_satir['id'].'&amp;cevap_no='.$cevap_satir['id'].'&amp;fsayfa='.$_GET['fs'].'&amp;sayfa='.$_GET['ks'].'"><img src="temalar/varsayilan/resimler/konuyuduzenle.png" alt="Bu cevabı değiştir" title="Bu cevabı değiştir"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">Düzenle</span></a>&nbsp;&nbsp;';

$cevap_alinti_duzenle .= '<a href="yonetim/ip_yonetimi.php?kip=1&amp;ip='.$cevap_satir['yazan_ip'].'"><img  src="temalar/varsayilan/resimler/ipadresleri.png" alt="Bu cevabı yazanın ip adresi" title="Bu cevabı yazanın ip adresi"><span style="font:bold 11px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#3e3e3e!important;text-decoration:none!important;position:relative;top:-2.21px;padding:0 5px;">İp</span></a>&nbsp;&nbsp;';
...
$cevap_bag = '<a href="'.linkver('konu.php?k='.$mesaj_satir['id'].'&ks='.$_GET['ks'], $mesaj_satir['mesaj_baslik'], '#c'.$cevap_satir['id']).'" style="color: #565656; text-decoration: none;font-size: 12px;" title="İletinin bağlantısı">#'.$ileti_no.' <image src="temalar/varsayilan/resimler/baglantitamgasi.png" style="padding-bottom: 5px;position: relative;top: 7.9px;left: -1.7px;" /></a>';
...
$cevap_tesekkur = '<a href="eklentiler/tesekkur/tesekkur.php?cevapno='.$cevap_satir['id'].'"><img src="temalar/varsayilan/resimler/arti.png" border="0" title="Bu mesaja teşekkür edin"><span style="font:bold 13px Tahoma, Calibri, Verdana, Geneva, sans-serif;color:#f1ebeb!important;text-decoration:none!important;position:relative;top:-3px;padding:0 5px;">Beğeni gönder</span></a>';
...
'{CEVAP_TSK_EDENLER}'  => $cvp_tsk_edenler,
...
$etiketler_cikti = '';
$benzer_cikti = '';
include 'eklentiler/benzer_konular/bnz_konu.php';
